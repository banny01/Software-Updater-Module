...
public class DownloadSFTP {
    ...
    public void download(int i) {
        //SFTP Server details
        String SFTPHOST = "192.168.13.76"; // SFTP Host Name or SFTP Host IP Address
        int SFTPPORT = 22; // SFTP Port Number
        String SFTPUSER = "ximager"; // User Name
        String SFTPPASS = "ximager"; // Password
        //Editable path variables from here
        String SFTPWORKINGDIR = "/usr/local/ximager/Desktop/Prismate"; // Source Directory on SFTP server  **** NEED TO EDIT THIS ****
        String LOCALDIRECTORY = System.getProperty("user.dir"); // Local Target Directory
        //To here
        ...
        //Editable path variables from here
        String SFTPWORKINGDIR = "/root/Capmate"; // Source Directory on SFTP server  **** NEED TO EDIT THIS ****
        String LOCALDIRECTORY = System.getProperty("user.dir"); // Local Target Directory
        //To here*/
